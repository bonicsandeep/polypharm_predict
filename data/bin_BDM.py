...
ppi_in_file = 'data_structures/BDM/PPI_BDM_genes_'+str(args.n_genes)
dti_in_file = 'data_structures/BDM/DTI_BDM_genes_'+str(args.n_genes)+'_drugs_'+\
              str(args.n_drugs)
ddi_in_file = 'data_structures/BDM/DDI_BDM_se_'+str(args.n_se)+'_drugs_'+str(args.n_drugs)
# ============================================================================================= #
# PPI
print('\n==== IMPORTED VARIABLES ====')
